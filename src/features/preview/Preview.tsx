...
export function Preview({ onEdit, onCoverLetter }: PreviewProps) {
  ...
  return (
    <div className="relative">
      ...
      <div className="print:hidden max-w-6xl mx-auto mb-4 md:mb-8 px-4 sm:px-6">
            ...
            {templates.map((tmpl) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-semibold text-gray-900 text-sm">{t(tmpl.nameKey)}</h3>
                    <p className="text-xs text-gray-500">{t(tmpl.descKey)}</p>
                  </div>
                  {selectedTemplate === tmpl.id && (
