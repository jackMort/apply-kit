...
export function Card({ children, className = '', variant = 'default', animated = false }: CardProps) {
  const variants = {
    default: 'bg-white/80 backdrop-blur-sm border border-slate-200/60 shadow-sm hover:shadow-md',
    elevated: 'bg-white shadow-lg shadow-slate-200/50 border-0 hover:shadow-xl',
